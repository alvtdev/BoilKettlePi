...
mashTime.grid(row=0, column=0)
mashTimeEntry.grid(row=0, column=1) 
mashTimeUnits.grid(row=0, column=2)
mashTemp1.grid(row=1, column=0)
mashTemp1Entry.grid(row=1, column=1)
mashTemp1Units.grid(row=1, column=2)
mashTemp2.grid(row=2, column=0)
mashTemp2Entry.grid(row=2, column=1)
mashTemp2Units.grid(row=2, column=2)
btsMT.grid(row=3, column=0)
sendMTData.grid(row=3, column=1)
